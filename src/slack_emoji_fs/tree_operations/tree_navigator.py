...
class TreeNavigator:
    ...
    def _resolve_inode[T: InodeObject](self, inode_id: str) -> ResolvedInode[T]:
    ...
    def _follow_child(self, parent_resolved_directory: ResolvedDirectory, child_name: str) -> PathStep:
        ...
        if child_name not in parent_resolved_directory.dirent_object.entries:
            raise PathNotFoundException(child_name)
    ...
    def resolve(self, root_inode_id: str, raw_path: str) -> ResolvedInode:
    ...
    def resolve_parent(self, root_inode_id: str, raw_path: str) -> ParentResolution:
        ...
        if path.is_root or parent_path is None:
            raise Exception("Tried to resolve parent of root path.")
